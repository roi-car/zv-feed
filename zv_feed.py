...
GPC_BY_LEAF = {
    ...
    # Card cases - 6170 = Apparel & Accessories > Handbags, Wallets & Cases > Badge & Pass Holders
    "card cases": 6170, "pass holders": 6170,
    ...
    "shorts": 207,
    # Sweaters/cardigans - 1604 = Apparel & Accessories > Clothing (generic parent;
    # no specific sweater code exists in modern Google taxonomy)
    "sweaters & cardigans": 1604, "sweaters": 1604,
    "cardigans": 1604, "knitwear": 1604,
...
GPC_BY_KEYWORD = [
    ...
    ("card case", 6170), ("card wallet", 2668),
    ...
    ("cardigan", 1604), ("sweater", 1604), ("knit", 1604),
    ("jumper", 1604), ("vest", 1831),
...
def infer_google_category(product_type: str, title: str) -> Optional[int]:
    ...
    Strategy:
    1. Try matching the leaf of product_type ('Bags > Clutches' -> 'clutches')
    2. Fall back to keyword matching in the title (handles collection-named
       leaves like 'Ceremony Collection' or 'Resort Selection')
    ...
    # Stage 2: title keyword scan
    if title:
        title_lower = " " + title.lower() + " "  # pad for word-boundary checks
...
def main():
    ...
    if args.urls:
        ...
        urls = discover_product_urls(session, SEED_CATEGORIES)
